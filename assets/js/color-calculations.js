 ...
 * @return {Object} - this
 */
function _openwebofficeColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_openwebofficeColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_openwebofficeColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_openwebofficeColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _openwebofficeColor object.
 *
 * @since Open Web Office 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function openwebofficeColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _openwebofficeColor( backgroundColor, accentHue );
